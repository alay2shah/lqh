...
SIZE_RECOMMENDATION = (
    ...
    "despite good data and a sane scorer. A near-floor zero-shot score from the "
    "230M/350M is normal and does not rule them out — a fine-tune on good data that "
    "still underperforms does. For the SFT base, instruct/no-suffix is "
