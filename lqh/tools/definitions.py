    ...
    base = [
        ...
        _tool(
            ...
            description=(
                ...
                "automatically when the watcher observes completion. In the "
                "interactive TUI the bottom status bar already shows live progress "
                "(phase, step count, percent, ETA) for every running job — when the "
                "user asks how to follow progress or how much is left, point them "
                "there instead of asking them to ask you. On a failed "
